...
final class TaskDetailViewController: UIViewController, TaskDetailScreen {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(
            TaskHeaderCollectionReusableView.self,
            forSupplementaryViewOfKind: self.headerKind,
            withReuseIdentifier: TaskHeaderCollectionReusableView.reuseIdentifier
        )
        collectionView.register(
            TaskInfoCollectionViewCell.self,
            forCellWithReuseIdentifier: TaskInfoCollectionViewCell.reusdeIdentifier
        )
        collectionView.register(
        ...
        collectionView.register(
            CreatorCollectionViewCell.self,
            forCellWithReuseIdentifier: CreatorCollectionViewCell.reusdeIdentifier
        )
        collectionView.register(
        ...
        collectionView.register(
            SubmissionCollectionViewCell.self,
            forCellWithReuseIdentifier: SubmissionCollectionViewCell.reuseIdentifier
        )
        collectionView.register(
            EditButtonCollectionViewCell.self,
            forCellWithReuseIdentifier: EditButtonCollectionViewCell.reuseIdentifier
        )
        collectionView.register(
            AddFileCollectionViewCell.self,
            forCellWithReuseIdentifier: AddFileCollectionViewCell.reuseIdentifier
        )
    ...
    init(deadline: Deadline) {
        ...
        taskViewModel = TaskViewModel(self, collectionView, AssignmentsNetworkManager(), deadline: deadline)
        ...
        let layout = UICollectionViewCompositionalLayout { (sectionIndex, _) -> NSCollectionLayoutSection? in
            ...
            case .taskFiles, .submission:
                let itemSize = NSCollectionLayoutSize(
                    widthDimension: .absolute(ScreenSize.Width - 32),
